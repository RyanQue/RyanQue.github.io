...
#  - name: Preparation
#    - name: I Loading Libraries
#    - name: II Reproducibility
#    - name: III Read Data
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/posts/airbnb6810/CRISP_DM_Diag.png" class="img-fluid rounded mx-auto d-block z-depth-1" width="12%" zoomable=true %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/posts/airbnb6810/barchar.png" class="img-fluid rounded mx-auto d-block z-depth-1" width="60%" zoomable=true %}
    </div>
</div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/posts/airbnb6810/heatmap.png" class="img-fluid rounded mx-auto d-block z-depth-1" width="60%" zoomable=true %}
    </div>
</div>
...
The following steps will elaborate on pre-processing the predictors. There are more than 60 predictors and I decided to group them by their meaning. 
...
Apparently, different hosts can have the same `host_name`, so this predictor is considered useless. **dropped**
...
> [Understanding response rate and acceptance rate - Resource Center - Airbnb](https://www.airbnb.com/resources/hosting-homes/a/sunderstanding-response-rate-and-acceptance-rate-86)
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/posts/airbnb6810/responsetime.png" class="img-fluid rounded mx-auto d-block z-depth-1" width="100%" zoomable=true %}
    </div>
</div>
...
About the 'superhost' , I found an explanation in Airbnb website:
...
However, the explanation above indicates that there might be correlation between the accommodation's condition with the `host_listings_count`, which will cause multicollinearity in linear models.(correlation is analysed later.)
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/posts/airbnb6810/verification.png" class="img-fluid rounded mx-auto d-block z-depth-1" width="100%" zoomable=true %}
    </div>
</div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/posts/airbnb6810/geometric_distribution.png" class="img-fluid rounded mx-auto d-block z-depth-1" width="100%" zoomable=true %}
    </div>
</div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/posts/airbnb6810/room_type.png" class="img-fluid rounded mx-auto d-block z-depth-1" width="100%" zoomable=true %}
    </div>
</div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/posts/airbnb6810/accommodates.png" class="img-fluid rounded mx-auto d-block z-depth-1" width="100%" zoomable=true %}
    </div>
</div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/posts/airbnb6810/bedrooms.png" class="img-fluid rounded mx-auto d-block z-depth-1" width="100%" zoomable=true %}
    </div>
</div>
...
Based on life experience, in the high season, if there are strategy in changing the settings of the minimum nights and maximum nights, minimum nights and maximum nights will be shorter, and the situation will be the opposite in the low season.
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/posts/airbnb6810/min_night.png" class="img-fluid rounded mx-auto d-block z-depth-1" width="100%" zoomable=true %}
    </div>
</div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/posts/airbnb6810/max_night.png" class="img-fluid rounded mx-auto d-block z-depth-1" width="100%" zoomable=true %}
    </div>
</div>
...
Instead of using decision tree, I choose random forest to get started. Random forest is more capable of diminishing the risk of overfitting.
...
Feature importance in tree-based models is based on Gini importance / impurity.
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/posts/airbnb6810/randomForestPlot.png" class="img-fluid rounded mx-auto d-block z-depth-1" width="100%" zoomable=true %}
    </div>
</div>
